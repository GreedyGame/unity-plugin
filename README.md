...
This is a complete guide to integrate GreedyGame plugin within your unity game. You can download [GreedyGame_v6.3.unitypackage](current-sdk/GreedyGame_v6.unitypackage).
